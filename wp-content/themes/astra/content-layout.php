...
<div class="listarticle">
    <article class="ast-col-sm-4" id="post-<?php the_ID(); ?>">
        ...
        <header class="entry-header">
            <a href="<?php the_permalink(); ?>" rel="bookmark"><h4 class="woocommerce-loop-product__title"><?php the_title(); ?></h4></a>
        ...
        <div class="entry-summary">
            <a class="pagemore" href="<?php the_permalink(); ?>"><?php esc_html_e('Añadir al carrito','astra'); ?></a>
        </div>
        <?php else : ?>
