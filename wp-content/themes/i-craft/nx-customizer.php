...
function icraft_custom_setting( $controls ) {
	...
	$controls[] = array(
		...
		'label'       => __( 'Turn ON Wide Topbar', 'i-craft' ),
		'description' => __( 'Increase topbar height', 'i-craft' ),
		'section'     => 'nxtopbar',
		'default'     => 0,
		'priority'    => 1,
	);	
	...
	$controls[] = array(
		...
		'label'       => __( 'Clickable Phone And Email', 'i-craft' ),
		'description' => __( 'Phone will open in WhatsApp and email in email client.', 'i-craft' ),
		'section'     => 'nxtopbar',
		'default'     => 0,
		'priority'    => 1,
	);
    ...
    $controls[] = array(
        ...
        'section'  => 'nxtopbar',
		'default'  => esc_url('https://www.facebook.com/wordpress'),		
        'priority' => 1,
    );	
    ...
    $controls[] = array(
		...
		'description' => __( 'Empty the field to remove the icon', 'i-craft' ),			
        'section'  => 'nxtopbar',
		'default'  => esc_url('https://www.twitter.com/wordpress'),
        'priority' => 1,
    );
    ...
    $controls[] = array(
		...
		'description' => __( 'Empty the field to remove the icon', 'i-craft' ),			
        'section'  => 'nxtopbar',
		'default'  => esc_url('https://www.instagram.com/wordpress'),
        'priority' => 1,
    );	
    ...
    $controls[] = array(
		...
		'description' => __( 'Empty the field to remove the icon', 'i-craft' ),			
        'section'  => 'nxtopbar',
		'default'  => esc_url('https://www.youtube.com/wordpress'),
        'priority' => 1,
    );
	$controls[] = array(
	...
	$controls[] = array(
		...
		'label'       => __( 'Header Style', 'i-craft' ),
		'description' => __( 'Select a header style', 'i-craft' ),
		'section'     => 'nxheader',
		'default'     => '1',
		'priority'    => 3,
		/*	
	...
	$controls[] = array(
		...
		'label'       => __( 'Maximum Logo Height', 'i-craft' ),
		'section'     => 'nxheader',
		'default'     => 64,
		'priority'    => 3,
		'choices'     => array(
	...
	$controls[] = array(
		...
		'label'       => __( 'Sticky Header Maximum Logo Height', 'i-craft' ),
		'section'     => 'nxheader',
		'default'     => 48,
		'priority'    => 3,
		'choices'     => array(
	...
	$controls[] = array(
		...
		'label'       => __( 'Turn ON Sticky Header', 'i-craft' ),
		'description' => __( 'Turn the sticky header on page scroll', 'i-craft' ),
		'section'     => 'nxheader',
		'default'     => 1,
		'priority'    => 4,
	);		
	...
	$controls[] = array(
		...
		'label'       => __( 'Turn ON Extra Shadows', 'i-craft' ),
		'description' => __( 'Shadows behind dropdown, top and bottom of the slider, page header, etc', 'i-craft' ),
		'section'     => 'layout',
		'default'     => 0,		
		'priority'    => 10,
	);	
	$controls[] = array(
		'type'        => 'radio-buttonset',
		'settings'     => 'backto_top',
		'label'       => __( 'Turn ON/OFF Back To Top Button', 'i-craft' ),
		'section'     => 'layout',
		'choices'     => array(
				'visible'  	=> esc_html__( 'Enable', 'i-craft' ),
				'hidden' 	=> esc_html__( 'Disable', 'i-craft' ),
			),			
		'default'     => 'visible',		
		'priority'    => 11,
		'output' => array(
