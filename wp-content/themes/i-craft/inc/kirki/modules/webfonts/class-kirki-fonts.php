...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'i-craft' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'i-craft' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'i-craft' ),
			'200'       => esc_html__( 'Light 200', 'i-craft' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'i-craft' ),
			'300'       => esc_html__( 'Book 300', 'i-craft' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'i-craft' ),
			'400'       => esc_html__( 'Normal 400', 'i-craft' ),
			'regular'   => esc_html__( 'Normal 400', 'i-craft' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'i-craft' ),
			'500'       => esc_html__( 'Medium 500', 'i-craft' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'i-craft' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'i-craft' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'i-craft' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'i-craft' ),
			'700'       => esc_html__( 'Bold 700', 'i-craft' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'i-craft' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'i-craft' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'i-craft' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'i-craft' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'i-craft' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'i-craft' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'i-craft' ),
		);
	}
