...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'i-craft' ),
				'change'       => esc_html__( 'Change image', 'i-craft' ),
				'default'      => esc_html__( 'Default', 'i-craft' ),
				'remove'       => esc_html__( 'Remove', 'i-craft' ),
				'placeholder'  => esc_html__( 'No image selected', 'i-craft' ),
				'frame_title'  => esc_html__( 'Select image', 'i-craft' ),
				'frame_button' => esc_html__( 'Choose image', 'i-craft' ),
			)
		);
	}
