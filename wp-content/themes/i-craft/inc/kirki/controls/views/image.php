...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'i-craft' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'i-craft' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'i-craft' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'i-craft' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'i-craft' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'i-craft' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'i-craft' ); ?>',
} );
#>
