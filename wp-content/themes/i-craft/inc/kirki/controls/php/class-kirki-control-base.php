	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'i-craft' ),
				'remove'               => esc_html__( 'Remove', 'i-craft' ),
				'default'              => esc_html__( 'Default', 'i-craft' ),
				'selectFile'           => esc_html__( 'Select File', 'i-craft' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'i-craft' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'i-craft' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'i-craft' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'i-craft' ),
			)
		);
