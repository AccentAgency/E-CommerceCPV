                ...
                <div class="nx-info-desc" style="width: 100%;">
                	...
                	<div class="nx-admin-row">
						...
						<div class="col-1-2" style="padding-left: 0px; margin-left: 0px; width: 60%;">
                        	<h2 style="margin: 12px 0px;"><?php esc_html_e('I-CRAFT Setup Guide', 'i-craft'); ?></h4>
                        	<div class="video-wrapperr">
                            	<a href="https://www.youtube.com/watch?v=Gh_roekInwg" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri() . '/inc/theme-welcome/images/setup-guide.png'); ?>" alt="" /></a>
                            </div>
                        </div>
                        <div class="col-1-2" style="padding-right: 0px; margin-right: 0px; width: 36%;">            	
							<div>
                            	<ul class="setup-list">
                                	<li><b><?php esc_html_e('0:03','i-craft'); ?> </b><?php esc_html_e('Installing TemplatesNext Toolkit', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('0:36','i-craft'); ?> </b><?php esc_html_e('Setting-up Top Menu', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('1:08','i-craft'); ?> </b><?php esc_html_e('Highlighting A Menu Item', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('1:49','i-craft'); ?> </b><?php esc_html_e('Adding Logo', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('2:58','i-craft'); ?> </b><?php esc_html_e('Maintenance/Coming Soon Mode', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('4:17','i-craft'); ?> </b><?php esc_html_e('Blog/Shop Page Settings', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('5.07','i-craft'); ?> </b><?php esc_html_e('Theme Slider', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('6:03','i-craft'); ?> </b><?php esc_html_e('Topbar Customization', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('6:53','i-craft'); ?> </b><?php esc_html_e('Header Customization', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('7:42','i-craft'); ?> </b><?php esc_html_e('Creating A Front Page', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('15:03','i-craft'); ?> </b><?php esc_html_e('Setting A Page As Your Front/Home Page', 'i-craft'); ?></li>
                                	<li><b><?php esc_html_e('15:34','i-craft'); ?> </b><?php esc_html_e('A Preview : Premium Theme I-SPIRIT', 'i-craft'); ?></li>
                                </ul>
                            </div>                                                       
                        </div>
                	...
                	<div class="nx-tab-content">
                        ...
                        <ul class="nx-welcome">
  							<?php
									echo '<li>';
									echo '<h3>';
									printf( esc_html__( 'Select Header Style', 'i-craft' ));
									echo '</h3>';
									printf( esc_html__( 'Select a header design for your website.', 'i-craft' ) );
                	...
                	<div class="nx-tab-content"> 
                        ...
                        <div class="popup" id="media-popup">
                        	<div class="nx-videowrapper">
                                ...
                                <div class="clvideo"><a href="#"><?php esc_html_e('Close Video', 'i-craft'); ?></a></div>
                            </div>
                        </div>                       
						<div class="tx-wspace-12"></div>
        			</div>      
...
function icraft_welcome_scripts() {
	...
	wp_localize_script('nx-welcome-script', 'recomended_notice', array( 'activation_button' => $activation_button ) );	
}
