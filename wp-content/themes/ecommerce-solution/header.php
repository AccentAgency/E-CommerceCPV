            ...
            <div class="col-lg-9 col-md-8 col-3">
              ...
              if(has_nav_menu('topmenus')){ ?>
                <div class="toggle-menu responsive-menu text-right">
                  <button role="tab" class="mobile-toggle" onclick="ecommerce_solution_responsive_menu_open()"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_responsive_menu_open_icon','fas fa-bars')); ?> mr-2"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','ecommerce-solution'); ?></span>
                  </button>
                </div>
              <?php }?>
                ...
                <nav id="site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'ecommerce-solution' ); ?>">
                  <?php if(has_nav_menu('topmenus')){
                    wp_nav_menu( array( 
                      ...
                      'menu_class' => 'clearfix',
                      'items_wrap' => '<ul id="%1$s" class="%2$s mobile_nav text-lg-right">%3$s</ul>',
                  ...
                  <?php }?>
                  <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="ecommerce_solution_responsive_menu_close()"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_responsive_menu_close_icon','fas fa-times')); ?> mr-2"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','ecommerce-solution'); ?></span></a>
                </nav>
              </div>
            </div>
          </div>
      ...
      <div class="mid-header py-4">
        <div class="container">
          <div class="row">
                  ...
                  <div class="search-cat-box p-2">
                    <div class="row m-0">
                      <div class="col-lg-6 col-md-6 border-cat py-2 px-4">
                        <button role="tab" class="product-btn"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_category_icon','fas fa-bars')); ?> mr-2"></i><?php echo esc_html_e('ALL CATEGORIES','ecommerce-solution'); ?><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_category_show_down_icon','fas fa-sort-down')); ?> ml-4"></i></button>
            ...
            <?php }?>
            <div class="col-lg-2 col-md-4 login-box my-2 mx-0">
                  ...
                  <?php
                    if(has_nav_menu('primary')){
                      wp_nav_menu( array( 
                        ...
                        'container_class' => 'main-menu-navigation clearfix' ,
                        'menu_class' => 'clearfix',
                        'items_wrap' => '<ul id="%1$s" class="%2$s mobile_nav m-0 pl-0 text-left">%3$s</ul>',
                        'fallback_cb' => 'wp_page_menu',
                      ) );
                    } 
                  ?>
